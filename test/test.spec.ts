...
describe('chai-almost', () => {
  it('Simple Approximate Equality', () => {
  ...
  it('Deep Approximate Equality', () => {
    const arrA = [1, [{num: 2, name: "Hans"}, 3]];
    const arrB = [1.0000001, [{num: 1.9999999, name: "Hans"}, 2.9999996]];
